    ...
    <form action={formAction} className="space-y-5">
      ...
      <fieldset className="space-y-3">
        ...
        <label className="flex cursor-pointer items-start gap-3 rounded-xl border border-zinc-800 bg-zinc-900/50 p-4 has-checked:border-sky-500/60">
          ...
          />
          <span>
            <span className="block font-medium text-white">Envío Starken</span>
            <span className="text-xs text-zinc-500">El costo del envío lo pagas tú.</span>
          </span>
        </label>
        <label className="flex cursor-pointer items-start gap-3 rounded-xl border border-zinc-800 bg-zinc-900/50 p-4 has-checked:border-amber-500/60">
          ...
          <span>
            ...
            <span className="text-xs text-zinc-500">Solo jueves o domingo.</span>
          </span>
        </label>
      </fieldset>
      ...
      >
        {pending ? "Guardando…" : "Confirmar datos de entrega"}
      </button>
    </form>
  );
}
